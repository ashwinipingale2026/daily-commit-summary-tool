...
- When creating skills, generate scripts that retrieve data from the file system and write it to other files during execution. This preserves tokens and minimizes hallucinations — the model should focus less on monitoring data and rely more on deterministic scripts developed within the skill.
